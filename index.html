...
<html lang="en">
  ...
  <body>
    <nav
      class="navbar fixed-top navbar-expand-sm navbar-light border bg-white" style="height: 54px;"
    >
      ...
      <div class="collapse navbar-collapse justify-content-center ml-5">
        <form class="form-inline my-2 my-lg-0 d-none d-sm-block ml-5">
          <input
      ...
      <div
        class="collapse navbar-collapse ml-5 mt-2 d-none d-md-block"
      >
        <ul class="navbar-nav">
    ...
    <div style="padding-top: 40px;" class="container middlearea offset-3 mt-4 d-flex">
      <div class="row pt-3 ">
        <div class="col-12 col-sm-6">
          ...
          <div class="card">
            <div class="card-header bg-white">
              ...
              <span class="mt-2 "
                ><strong><i style="margin-left: 315px;" class="fas fa-ellipsis-h"></i></strong
              ></span>
            </div>
            <img
                ...
                <li class="nav-item ml-4">
                  <a class="nav-link ml-2" href="#"
                    ><i
                      ...
                      style="color: black; position: relative; font-size: 23px; margin-left: 310px;"
                    ></i
                  ></a>
                </li>
              </span>
            ...
            <div
              class="card-footer bg-white commentNoBorder"
              style="
                color: rgb(139, 133, 133);
            ...
            >
              ...
              ><span class="" style="color: #0095f6; opacity: 50%; margin-left: 380px"
            ...
            <div class="card-body d-flex" >
              <div>
                ...
                <div class="mt-2">
                  ...
                  >
                  <span
                    class="postuserfont mt-1 alignRight"
